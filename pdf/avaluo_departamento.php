...
$pdf->SetFont('Arial', 'B', 12);
/* $pdf->SetTextColor(21, 137, 156); */
$pdf->Text(21, 35, '4.- SERVICIOS BÁSICOS.-');
$pdf->SetFont('Arial', '', 9);
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 40, 170, 35, "FD");
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(44, 45, 'SERVICIOS  : ');
$pdf->Text(104, 45, 'EL INMUEBLE  : ');
$pdf->Text(154, 45, 'LA ZONA  : ');
$pdf->Text(24, 50, 'AGUA POTABLE ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(104, 50, $arrayTabla5['Agua_Zona']);
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 55, 'ENERGIA ELÉCTRICA');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(104, 55, $arrayTabla5['Energia_Zona']);
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 60, 'SERVICIO TELEFÓNICO ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(104, 60, $arrayTabla5['Telefono_Zona']);
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 65, 'ALCANTARILLADO PÚBLICO ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(104, 65, $arrayTabla5['Alcantarillado_Zona']);
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 70, 'GAS DOMICILIARIO ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(104, 70, $arrayTabla5['Gas_Zona']);
...
$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 80, 170, 27, "FD");
$pdf->SetFont('Arial', 'B', 11);
$pdf->Text(24, 85, 'OBSERVACIONES : ');
$pdf->SetFont('Arial', '', 10);
$pdf->SetY(88);
$pdf->SetX(24);
...
//***************************************TABLA 6***********************
$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(21, 125, '5.- CARACTERÍSTICAS DE LA EDIFICACIÓN.-');
$pdf->SetFont('Arial', 'B', 12);
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 130, 170, 49, "FD");
$pdf->Text(24, 135, 'USO  : ');
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 140, 'RESIDENCIAL  : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(54, 140, $arrayTabla6['Residencial']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(74, 140, 'OFICINA  : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(94, 140, $arrayTabla6['Oficina']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(114, 140, 'COMERCIAL  : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(137, 140, $arrayTabla6['Comercial']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(154, 140, 'OTROS  : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(170, 140, $arrayTabla6['Otros_Uso']);

$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(24, 145, 'OCUPACIÓN  : ');
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 150, 'PROPIETARIOS  : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(54, 150, $arrayTabla6['Propietarios']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(74, 150, 'INQUILINOS  : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(97, 150, $arrayTabla6['Inquilinos']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(114, 150, 'OTROS  : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(134, 150, $arrayTabla6['Otros_Ocupacion']);

$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(24, 155, 'TIPO  : ');
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 160, 'LUJO : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(54, 160, $arrayTabla6['Lujo']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(74, 160, 'SEMILUJO : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(94, 160, $arrayTabla6['Semilujo']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(114, 160, 'STANDART : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(137, 160, $arrayTabla6['Standart']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(154, 160, 'ECONÓMICO : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(176, 160, $arrayTabla6['Economico']);

$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(24, 165, 'ESTADO : ');
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 170, 'BUENO : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(54, 170, $arrayTabla6['Bueno']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(74, 170, 'REGULAR : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(94, 170, $arrayTabla6['Regular']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(114, 170, 'MALO : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(137, 170, $arrayTabla6['Malo']);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(154, 170, 'MUY MALO : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(176, 170, $arrayTabla6['Muy_Malo']);

$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(24, 175, 'ANTIGUEDAD : ');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(60, 175, $arrayTabla6['Antiguedad']);

$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 179, 170, 25, "FD");
$pdf->SetFont('Arial', 'B', 11);
$pdf->Text(24, 185, 'DESCRIPCIÓN : ');
$pdf->SetFont('Arial', '', 10);
...
$pdf->SetFont('Arial', '', 9);
$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 215, 170, 12, "FD");
$pdf->Text(24, 220, 'NUMERO DE AMBIENTES : ');
$pdf->Text(74, 220, $arrayTabla6['Numero_Ambientes']);
$pdf->Text(24, 225, 'NUMERO DE BLOQUES : ');
$pdf->Text(74, 225, $arrayTabla6['Numero_Bloques']);
...
//*****************************TABLA 8**********************************
$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(21, 40, '6.- CALCULO DEL VALOR CATASTRAL DE LA CONSTRUCCIÓN.- ');
...
//*****************************TABLA 10**********************************
$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(21, 95, '7.- CALCULO DEL VALOR TECNICO COMERCIAL DE LA CONSTRUCCION.- ');
$pdf->SetFont('Arial', '', 9);
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 100, 170, 30, "FD");

$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 105, 'SUPERFICIE CONSTRUIDA : ');
$pdf->SetFont('Arial', '', 9);
$pdf->line(21, 106, '191', '106');
$pdf->Text(154, 105, number_format($arrayTabla10['Superficie_Construida'], 2));
$pdf->Text(180, 105, 'MT2');

$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 110, 'VALOR COMERCIAL MT2.CONSTRUIDO : ');
$pdf->SetFont('Arial', '', 9);
$pdf->line(21, 111, '191', '111');
$pdf->Text(154, 110, number_format($arrayTabla10['Valor_Comercial_Mt2_Construido'], 2));
$pdf->Text(180, 110, '$US.');


$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 115, 'FACTOR DE DEPRECIACIÓN : ');
$pdf->SetFont('Arial', '', 9);
$pdf->line(21, 116, '191', '116');
$pdf->Text(154, 115, number_format($arrayTabla10['Factor_Depreciacion'], 2));
$pdf->Text(180, 115, '%');

$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 120, 'VALOR TOTAL DE LA CONSTRUCCIÓN MT2. : ');
$pdf->SetFont('Arial', '', 9);
$pdf->line(21, 121, '191', '121');
$pdf->Text(154, 120, number_format($arrayTabla10['Valor_Total_Construccion_Mt2'], 2));
$pdf->Text(180, 120, '$US.');

$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 125, 'VALOR TOTAL DE LA CONSTRUCCIÓN : ');
$pdf->SetFont('Arial', '', 9);
$pdf->line(21, 126, '191', '126');
$pdf->Text(154, 125, number_format($arrayTabla10['Valor_Total_Construccion'], 2));
$pdf->Text(180, 125, '$US.');

$pdf->SetTextColor(0, 0, 0);
$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 130, 170, 5, "FD");

$total = $arrayTabla10['Valor_Total_Construccion'];
$V = new EnLetras();
$con_letra = strtoupper($V->ValorEnLetras($total, " 00/100 DÓLARES"));
$pdf->Text(24, 134, $con_letra);

//$pdf->Text(21, 209, "Tipo de cambio : Bolivianos " . $arrayTabla0['Tipo_Cambio']);
//*****************TABLA 11***********************

$pdf->SetFont('Arial', 'B', 12);
$pdf->Text(21, 148, '8.- TOTALES.-');
$pdf->SetFont('Arial', 'B', 11);
$pdf->Text(29, 165, '•	AVALUÓ TÉCNICO COMERCIAL FINAL DEL INMUEBLE.-');
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFillColor(255, 255, 255);
...
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(90, 174, 'VALOR UNITARIO');
$pdf->line(21, 175, '191', '175');
$pdf->Text(132, 174, 'SUPERFICIE');
...
$pdf->SetFont('Arial', '', 9);
$pdf->Text(90, 179, number_format($arrayTabla11['Valor_Unitario_T'], 2));
$pdf->Text(132, 179, number_format($arrayTabla11['Superficie_T'], 2));
$pdf->Text(170, 179, number_format($arrayTabla11['Total_T'], 2));
$pdf->Text(90, 184, number_format($arrayTabla11['Valor_Unitario_C'], 2));
$pdf->Text(132, 184, number_format($arrayTabla11['Superficie_C'], 2));
$pdf->Text(170, 184, number_format($arrayTabla11['Total_C'], 2));
$pdf->SetFillColor(255, 255, 255);
$pdf->Rect(21, 192, 170, 5, "FD");
$pdf->SetFont('Arial', 'B', 9);
$pdf->Text(24, 196, 'VALOR COMERCIAL TOTAL: 	');
$pdf->SetFont('Arial', '', 9);
$pdf->Text(150, 196, '$US.');
$pdf->Text(170, 196, number_format($arrayTabla11['Valor_Comercial_Total'], 2));
$pdf->Text(21, 202, "Tipo de cambio : Bolivianos " . $arrayTabla0['Tipo_Cambio']);
$pdf->SetTextColor(0, 0, 0);
$pdf->AddPage();
$pdf->SetTextColor(0, 0, 0);
//*****************TABLA 112***********************
