$(document).ready(function() {
    $('#imprimir').hover(function() {
        var VALORDELTERRENOINMUEBLE = '';
        var VALORDELTERRENOSUPERFICIEINMUEBLE = '';
        var VALORDELTERRENOTOTALINMUEBLE = '';
        var VALORDELACONSTRUCCIONINMUEBLE = $('#VALORDELACONSTRUCCIONINMUEBLE').attr('value');
        var VALORDELACONSTRUCCIONSUPERFICIEINMUEBLE = $('#VALORDELACONSTRUCCIONSUPERFICIEINMUEBLE').attr('value');
        var VALORDELACONSTRUCCIONTOTALINMUEBLE = $('#VALORDELACONSTRUCCIONTOTALINMUEBLE').attr('value');
